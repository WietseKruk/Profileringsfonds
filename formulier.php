...
<div class="container">
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <p><b>20. Heb je eerder een inschrijving bij een
                                    andere instelling (HBO/Universiteit) gehad? Zo ja, bij welke instelling, en welke
                                    periode</b>
                ...
                <div class="formvragen">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            Activiteiten op bestuurlijk of maatschappelijk gebied die naar het oordeel van het College
                            van
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <p><b>24. Heb je recht (gehad) op een extra jaar
                                    studiefinanciering/aanvullende beurs via DUO?. Zo ja, voeg het bewijs toe bij de
                                    bijlagen</b>
                            </p>
                        </div>
                        <div class="col-sm-2">
        ...
        <div class="formvragen">
            <div class="row">
                <div class="col-sm-10">
                    <p><b>30. Op welke datum en bij wie heb je melding gemaakt van deze bijzondere
                            omstandigheid?</b><br>
        ...
        <div class="formvragen">
            <div class="row">
                <div class="col-sm-10">
                    <p><b> 35. Op welke wijze heb je geprobeerd de negatieve gevolgen van de bijzondere omstandigheid
                            voor
